"""
Bot V3 V2 — Agressieve DOGE+SOL Paper Trading Bot (multi-agent)
================================================================
Portfolio: DOGE, SOL via Bitvavo publieke API (EUR pairs).
...
State:     state_v3_v2.json in GitHub repo.
"""
...
# ── Config ────────────────────────────────────────────────────────────────────
BOT_ID        = "v3_v2"
GH_STATE_FILE = "state_v3_v2.json"
...
def main():
    print("=" * 65)
    print(f"  Bot V3 V2 (multi-agent, DOGE+SOL)  —  "
          f"{datetime.now(timezone.utc).strftime('%Y-%m-%d %H:%M')} UTC")
    print("=" * 65)

    init_clients()

    if not check_meta_config("v3_v2"):
        return
